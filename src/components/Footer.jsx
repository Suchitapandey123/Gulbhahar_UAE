      ...
      <div className="container mx-auto max-w-7xl">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mb-12">
          <div className="space-y-3 -ml-12">
            <Link href="/collection" className="block hover:underline text-center sm:text-left font-raleway text-[22px]">
              COLLECTIONS
            </Link>
          ...
          <div className="flex justify-center sm:justify-start items-center gap-3 mt-6 sm:mt-0">
