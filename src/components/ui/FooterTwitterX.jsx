...
const FooterTwritterX = (props) => (
  ...
  >
    <path
      d="M12.154 10.7294L8.08868 5.04102H5.92041L10.9563 12.0869L11.5902 12.9733L15.9006 19.0094H18.0689L12.7852 11.6157L12.154 10.7294Z"
      fill="black"
    />
    <path
...
export default FooterTwritterX;