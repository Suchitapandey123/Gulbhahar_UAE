...
export default function Transaction() {
  return (
    <div className="max-w-md mx-auto p-6 space-y-6 font-raleway">
      <div className="text-center space-y-2 lg:mt-28">
      ...
      <Button className="w-full bg-black text-white hover:bg-slateFour lg:rounded-[12px]">Continue Shopping</Button>
    </div>
  )
}
