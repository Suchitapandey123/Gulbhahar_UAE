...
export default function TrackOrderComingSoon({ onBack = () => {} }) {
  return (
    <div className=" bg-gradient-to-br from-red-50/40 via-white to-red-50/20 flex items-center justify-center px-0 py-2 lg:py-0">
      <div className=" w-full mx-auto p-0 lg:p-4">
        ...
        {/* Main Box */}
        <div className="bg-white/80 backdrop-blur-xl border border-red-100 shadow-xl rounded-2xl p-8 sm:p-12 text-center transform transition-all">
          {/* Icon */}
          <div className="mx-auto mb-6 w-20 lg:w-24 h-20 lg:h-24 rounded-2xl bg-gradient-to-br from-red-100 via-white to-red-50 shadow-inner flex items-center justify-center">
            <Clock className="w-8 lg:w-12 h-8 lg:h-12 text-red-900 animate-pulse" />
          </div>
          ...
          <p className="text-gray-600 text-sm sm:text-base max-w-lg mx-auto text-justify leading-relaxed mb-8">
            We’re working hard to bring you a powerful order tracking experience.
            Soon, you'll be able to monitor your shipments, check delivery
            updates, and view order history—all in one place.
          </p>

          {/* Feature Highlights */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            <div className="bg-red-50 border border-red-100 rounded-xl p-2 lg:p-5 flex flex-col items-center gap-3 shadow-sm">
              <Package className="w-8 h-8 text-red-900" />
          ...
          {/* Coming Soon Tag */}
          <div className="inline-block px-6 py-3 bg-red-900 text-white rounded-lg shadow-lg text-sm sm:text-base font-medium hover:bg-red-800 transition-colors">
            Coming Soon
          </div>

          {/* Decorative Line */}
          <div className="w-24 h-1 bg-gradient-to-r from-red-900 via-red-700 to-red-500 rounded-full mx-auto mt-8" />
        </div>
      </div>
    </div>
  );
