        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="bg-white p-3 rounded-lg border border-red-200">
                <ul className="list-disc pl-5 space-y-2 text-sm sm:text-base text-gray-700">
                  <li>We do not offer direct exchanges. If you wish to receive a different size, you must initiate a return request for the original item in accordance with our return policy.</li>
                  <li>Once your return is approved and processed, you may place a new order for your desired size as a separate transaction.</li>
                  <li>Please note that availability of sizes is not guaranteed and is subject to current stock levels.</li>
                </ul>
              </div>
              ...
              <div className="bg-white p-3 rounded-lg border border-red-200">
                <ul className="list-disc pl-5 space-y-2 text-sm sm:text-base text-gray-700">
              <li>For approved return requests, we will arrange a reverse pickup through our designated courier partner at the address provided during the original order. Customers will be notified of the scheduled pickup date and must ensure the item is securely packed in its original packaging, with tags intact. In case the pickup is missed, one additional attempt will be made. If the pickup fails after two attempts, the customer will be responsible for shipping the item back at their own cost.</li>
                </ul>
              </div>
            </div>
          </div>
