    ...
    <div className="w-full space-y-8">
      ...
      <div className="bg-white rounded-2xl shadow-xl border border-red-100 p-8 text-center space-y-8">
        ...
        <div>
          ...
          <p className="text-red-600 mt-2">Please enter the 6-digit code below to continue</p>
        </div>
        ...
        <div className="flex justify-center space-x-2 sm:space-x-4">
          {[0, 1, 2, 3, 4, 5].map((index) => (
            <input
              ...
              className="w-12 h-12 sm:w-16 sm:h-16 text-center border-2 border-red-300 rounded-xl text-lg sm:text-2xl font-bold text-red-900 focus:border-red-900 focus:outline-none focus:ring-4 focus:ring-red-100 transition-all duration-200 bg-red-50/30"
            />
          ))}
        </div>
