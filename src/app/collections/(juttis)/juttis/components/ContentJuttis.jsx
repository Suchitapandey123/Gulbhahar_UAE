          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              <div className="bg-white border border-red-200 rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-sm">
                <p className="font-bold text-red-900 text-base sm:text-lg mb-2 sm:mb-3">Quality Materials</p>
              ...
              <div className="bg-white border border-red-200 rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-sm">
                <p className="font-bold text-red-900 text-base sm:text-lg mb-2 sm:mb-3">Sustainable Practices</p>
              ...
              <div className="bg-white border border-red-200 rounded-lg sm:rounded-xl p-4 sm:p-6 shadow-sm sm:col-span-2 lg:col-span-1">
                <p className="font-bold text-red-900 text-base sm:text-lg mb-2 sm:mb-3">Meaningful Purchase</p>
