...
export default function QuickTag({ popularTags = [], products = [] }) {
  ...
  return (
    ...
    >
      <div className="flex flex-wrap gap-8">
        {/* Left Half: Popular Tags */}
        <motion.div className="flex-1 min-w-[300px]" variants={sectionVariants}>
              ...
              <motion.div key={index} variants={itemVariants} className="group">
                <Link href={product.link}>
                  <motion.div
                    ...
                    whileHover="hover"
                    whileTap="tap"
                    className="relative p-4 bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 cursor-pointer overflow-hidden"
                  >
                    <motion.div
                    ...
                    <div className="relative z-10">
                      <h4
                        className={`${oldStandardTT.variable} text-sm lg:text-base font-medium text-gray-700 group-hover:text-red-700`}
                      >
                        {product.name}
                      </h4>
                      <p
                        className="text-sm text-gray-500 group-hover:text-red-600 mt-1"
                      >
                        {product.price}
                      </p>
                    </div>
