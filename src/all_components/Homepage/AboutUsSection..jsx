  ...
  const stories = [
    {
      ...
      description: "Our artisans carry forward a legacy spanning centuries, where each stitch tells a story of cultural richness and unmatched skill. Every piece is meticulously handcrafted using techniques passed down through generations."
    },
    {
      id: 2,
      image: A2,
      ...
      description: "We blend time-honored techniques with cutting-edge design, creating pieces that honor the past while embracing the future. Our innovative approach ensures that traditional craftsmanship evolves with modern sensibilities."
    },
    {
      id: 3,
      image: A3,
      ...
      description: "Every creation reflects our commitment to sustainable practices, ensuring beauty that doesn't compromise our planet's future. We source responsibly and create with environmental consciousness at the forefront."
    }
  ];
          ...
          <div className="space-y-6 sm:space-y-8">
            <div>
              ...
              <p className="text-base sm:text-lg text-gray-600 max-w-2xl mx-auto">
                Discover our complete collection and find the perfect piece that tells your story.
              </p>
            </div>
