...
export function ReviewForm({
  ...
  return (
    <div
      className={`mb-6 p-${isMobile ? "4" : "6"} bg-gray-50 rounded-lg border`}
    >
      <div className="flex items-center justify-between mb-4">
        <h4
          className={`font-${isMobile ? "medium text-sm" : "semibold text-lg"}`}
        >
          Write a Review
        </h4>
        <button
      ...
      <div className="mb-4">
        <p
          className={`text-${isMobile ? "xs" : "sm"} text-gray-600 mb-${isMobile ? "2" : "3"}`}
        >
          Rating:
        </p>
